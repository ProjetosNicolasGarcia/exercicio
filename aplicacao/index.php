                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 col-md-12">
                                                        ...
                                                        <p>Uma API REST (também chamada de API RESTful ou web API RESTful) é uma interface de programação de aplicativos (API) que fornece uma maneira flexível de integrar aplicações e conectar componentes em arquiteturas de microsserviços, baseado no estilo arquitetônico REST (transferência de estado representacional).</p>
                                                        <h2>COMO ESTA FUNCIONA??</h2>
                                                        <p>As requisições são enviadas ao servidor através dos verbos http e a api media a interação entre o que é exibido na tela e o banco de dados para realizar operações com alunos e com cursos</p>
                                                        <h2>VAI CORINTHIANS!</h2>
                                                        <img src="assets/images/corinthians.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
